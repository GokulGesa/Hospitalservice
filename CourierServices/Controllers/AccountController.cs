...
namespace CourierServices.Controllers
{
    public class AccountController : ApiController
    {
        ...
        public List<SampleContainersByMrdNo> getSampleListByMrdNoProfile(int profileID, string mrdNo)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    //string strSQL = "SELECT* FROM pathoclinic.ChildTestList where ProfileID = '" + profileID + "' order by ProfilePriority,ProfilePriority asc";
        ...
        //    physicalGrandparentPath = @"D:/Images/";
        ...
        public void deleteImagebyTestCode(string testCode,string imageName)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    string strSQL = "delete FROM pathoclinic.imagefortest where TestCode = '" + testCode + "' and ImageName = '" + imageName + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
                    cmd.CommandType = CommandType.Text;
                    cmd.ExecuteNonQuery();
        ...
        public List<Login> UploadSignatureImages()
        {
         ...
         //   physicalGrandparentPath = @"D:/Images/";
            ...
            //    C:\Program Files\Apache Software Foundation\Tomcat 7.0\webapps\patho
            System.Web.HttpFileCollection hfc = System.Web.HttpContext.Current.Request.Files;
            // CHECK THE FILE COUNT.
            for (int iCnt = 0; iCnt <= hfc.Count - 1; iCnt++)
            {
        ...
        public void updateAlternativeSampleContainer(Alternativesamplecontainer alternativesample)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    string strSQL = "SELECT * from pathoclinic.alternativesamplecontainer where TestCode='" + alternativesample.TestCode + "' and AlternativeSampleName='" + alternativesample.AlternativeSampleName + "'";
                    conn.Open();
                    MySqlDataAdapter mydata = new MySqlDataAdapter(strSQL, conn);
                    MySqlCommandBuilder cmd = new MySqlCommandBuilder(mydata);
                    DataSet ds = new DataSet();
                    ...
                    if (dt.Rows.Count == 1)
                    {
                        ...
                        string strSQL2 = "UPDATE  pathoclinic.alternativesamplecontainer SET AlternativeSampleName='" + alternativesample.AlternativeSampleName + "' where TestCode='" + alternativesample.TestCode + "' AND AlternativeSampleContainerId='" + alternativesample.AlternativeSampleContainerId + "'";
                      //  conn.Open();
        ...
        public void updateLocationDetails(Location location)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    string strSQL = "UPDATE pathoclinic.Location SET LocationName='" + location.LocationName + "' where LocationCode='" + location.LocationCode + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
       ...
       public List<corporate> getcorporatename()
        ...
        public void insertCultureTestResult(CultureTestResult cultureTestResult)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    string strSQL = "INSERT INTO pathoclinic.culturetestresult(MrdNo,TestCode,TestName,Specimen,GrainStain,SpecialStain,Result,OrganizismIsolated,ColonyCount,Comments,OrganizismIsolated2,ColonyCount2,Comments2,Remarks,Status) VALUES(@val1,@val2,@val3,@val4,@val5,@val6,@val7,@val8,@val9,@val10,@val11,@val12,@val3,@val4,@val15)";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
        ...
        public void insertAntiMicrobialsusceptibility1(AntiMicrobialsusceptibility1 antiMicrobialsusceptibility1)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    string strSQL = "INSERT INTO pathoclinic.antimicrobialsusceptibility1(MrdNo,TestCode,Agent,zoneInhibition,Interpretation) VALUES(@val1,@val2,@val3,@val4,@val5)";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
        ...
        public List<AddTitle> getTitleList()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    string strSQL = "SELECT * FROM pathoclinic.addtitle";
                    conn.Open();
                    MySqlDataAdapter mydata = new MySqlDataAdapter(strSQL, conn);
                    MySqlCommandBuilder cmd = new MySqlCommandBuilder(mydata);
                    DataSet ds = new DataSet();
        ...
        public void updateAddTitleDetails(AddTitle Title)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    string strSQL = "UPDATE pathoclinic.addtitle SET TitleName='" + Title.TitleName + "' where TitleId='" + Title.TitleId + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
        ...
        public void updatecorporateDetails(corporate corporate)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    string strSQL = "UPDATE pathoclinic.corporate SET Corporatename='" + corporate.Corporatename + "' where corporateId='" + corporate.corporateId + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
        ...
        public void updateCollectedAtDetails(CollectedAt collectedat)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    string strSQL = "UPDATE pathoclinic.collectedat SET CollectedName='" + collectedat.CollectedName + "', Amount= '" + collectedat.Amount + "' where CollectedId = '" + collectedat.CollectedId + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
        ...
        public void updateDoctorDetails(Doctor doctor)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    string strSQL = "UPDATE pathoclinic.doctor SET DoctorName='" + doctor.DoctorName + "', EmailId= '" + doctor.EmailId + "',PhoneNo='" + doctor.PhoneNo + "' where DoctorId = '" + doctor.DoctorId + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
        ...
        public void updatepatientdetailsinfo(PatientRegistration patientdetails)
        {
            using (MySqlConnection conn = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["MasterMani"].ConnectionString))
            {
                try
                {
                    ...
                    string strSQL = "UPDATE pathoclinic.patientregistration SET FirstName='" + patientdetails.FirstName + "', MiddleName='" + patientdetails.MiddleName + "', LastName='" + patientdetails.LastName + "', MaritalStatus='" + patientdetails.MaritalStatus + "', PhoneNumber='" + patientdetails.PhoneNumber + "', ContactEmail='" + patientdetails.ContactEmail + "',Sex='" + patientdetails.Sex + "' where RegID='" + patientdetails.RegID + "'";
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand(strSQL, conn);
